										...
										<Carousel controls={false} indicators={false}>
											<Carousel.Item>
												<Image
													...
													src="/admin-naroden-org/images/background/slider-img-1.jpg"
													alt="First slide"
												/>
											</Carousel.Item>
											<Carousel.Item>
												<Image
													className="d-block w-100"
													src="/admin-naroden-org/images/background/slider-img-2.jpg"
													alt="Second slide"
												/>
											</Carousel.Item>
											<Carousel.Item>
												<Image
													className="d-block w-100"
													src="/admin-naroden-org/images/background/slider-img-3.jpg"
													alt="Third slide"
												/>
											</Carousel.Item>
										</Carousel>
